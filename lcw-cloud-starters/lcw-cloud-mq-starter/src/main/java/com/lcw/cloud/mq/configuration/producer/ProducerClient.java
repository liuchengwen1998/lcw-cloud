...
public class ProducerClient {
     ...
     * @param body
     */
    public void buildMessage(String topic, String tag, String body) {
        Message msg = new Message(topic, tag, body.getBytes());
        msg.setKey(UUID.randomUUID().toString());
        buildMessage(msg, NumberUtils.INTEGER_ZERO, null);
    }
     ...
     * @since 1.0.8
     */
    public void buildMessage(String topic, String tag, String body, RocketMessageCallBack rocketMessageCallBack) {
        Message msg = new Message(topic, tag, body.getBytes());
        msg.setKey(UUID.randomUUID().toString());
        buildMessage(msg, NumberUtils.INTEGER_ZERO, rocketMessageCallBack);
    }
     ...
     * @since 1.0.8
     */
    public void buildMessage(String topic, String tag, Object body, RocketMessageCallBack rocketMessageCallBack) {
        buildMessage(topic, tag, JSONObject.toJSONString(body), rocketMessageCallBack);
    }

    public void buildMessage(String topic, String tag, Object body) {
        buildMessage(topic, tag, JSONObject.toJSONString(body), null);
    }
     ...
     * @since 1.0.8
     */
    public void buildDelayMessage(String topic, String tag, String body, long delayTime, RocketMessageCallBack rocketMessageCallBack) {
        Message msg = new Message(topic, tag, body.getBytes());
        msg.setKey(UUID.randomUUID().toString());
     ...
     * @since 1.0.8
     */
    public void buildDelayMessage(String topic, String tag, Object body, long delayTime) {
        buildDelayMessage(topic, tag, JSONObject.toJSONString(body), delayTime, null);
    }

    private void buildMessage(Message msg, Integer num, RocketMessageCallBack rocketMessageCallBack) {
        try {
            ...
            if (num <= NumberUtils.INTEGER_TWO) {
                buildMessage(msg, ++num, rocketMessageCallBack);
            } else {
